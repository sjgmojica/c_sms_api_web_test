...
<table class="body-wrap" cellpadding="0" cellspacing="0" style="width:100%; box-sizing:border-box; table-layout:fixed; max-width:37.5em; margin:auto;">
	<tr>
		...
		<td class="container" bgcolor="#FFFFFF"style="display:block;margin:0 auto; clear:both; border:1px solid #435D74;">
			...
			<div class="content" style="padding:2em;margin: 0px auto; display: block; box-sizing: border-box; word-wrap: break-word;">
                {0}
                <div class="closing" style="margin-top:2em;">
                    <p style="margin:0;">Thanks,</p>
                    <p style="margin:0;">The Chikka API Team</p>
                </div>
			</div><!-- /content -->
...
formatted_text_body="""{0}

Thanks,
The Chikka API Team

Terms and Conditions - https://api.chikka.com/terms-conditions
Privacy Statement - https://api.chikka.com/privacy"""
