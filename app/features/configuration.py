...
class Configuration(object):
    ...
    def load_locally():
        ...
        root_path = os.path.dirname(__file__).replace('features', '')
        conf_file =   os.path.join( root_path   , LOCAL_CONFIG % str(options.config))
