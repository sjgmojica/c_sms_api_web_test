'''
@author: this is the interface object that must be implemented in the paypal mysql DAO

'''
from datetime import datetime, timedelta

class PaypalMySqlDAOInterface(  ):
    '''
...
class DummyDao(  object, PaypalMySqlDAOInterface):
