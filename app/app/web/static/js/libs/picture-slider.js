...
var PictureSlider = new Class({
	 ...
	 */
	switchTo: function(n, leftLink, rightLink) {
	 ...
	 */
	left: function(leftLink, rightLink) {
		return this.switchTo(this.n - 1, leftLink, rightLink);
	},
	
	/*
	 * Switches to the next image.
	 */
	right: function(leftLink, rightLink) {
		return this.switchTo(this.n + 1, leftLink, rightLink);
	},
